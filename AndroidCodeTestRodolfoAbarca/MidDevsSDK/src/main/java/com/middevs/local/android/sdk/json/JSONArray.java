...
public final class JSONArray {
     ...
     * Appends {@code $value} to the end of this array.
     *
     * @param value a finite $value. May not be {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
     *              infinities}.
     * @return this array.
     */
    ...
    public JSONArray putOpt(int index,
                            Object value) {
     ...
     *
     * @throws JSONException if this array has no $value at {@code index}, or if that $value is the {@code null}
     ...
     *
     * @throws JSONException if the $value at {@code index} doesn't exist or cannot be coerced to a int.
     */
