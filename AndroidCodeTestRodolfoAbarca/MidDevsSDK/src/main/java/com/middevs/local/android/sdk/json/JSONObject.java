...
public final class JSONObject {
     ...
     *
     * @param number a finite $value. May not be {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
     *               infinities}.
     */
    ...
    public JSONArray names() {
        ...
        return nameValuePairs.isEmpty() ? null : new JSONArray(new ArrayList<String>(
                nameValuePairs.keySet()));
    }
